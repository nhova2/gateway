...
const ACTEURTYPES: string[] = ['Client', 'Fournisseur', 'Fournisseur'];
@Component({
  selector: 'app-main-fourniss',
  templateUrl: './main-fourniss.component.html',
  styleUrls: ['./main-fourniss.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})

export class MainFournissComponent implements OnInit, OnDestroy 
{
...
crudComp: CrudPopupComponent;
    ...
    ngOnInit(): void
    {
        console.log ("MainFournissComponent ngOnInit")
        // Get the widgets from the service
       // this.widgets = this._fournissService.widgets;
       this.widgets = this._fournissService.widgets;
		this.dataSource.paginator = this.paginator;
		this.dataSource.sort = this.sort;
		
		
		this._fournissService.homeMainOnChanged
