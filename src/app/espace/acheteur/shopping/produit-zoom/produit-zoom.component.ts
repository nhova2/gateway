...
@Component({
  ...
  templateUrl: './produit-zoom.component.html',
  styleUrls: ['./produit-zoom.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ProduitZoomComponent implements OnInit {
  
  @ViewChild('zoomImage') zoomImage;

  constructor(public dialogRef: MatDialogRef<ProduitZoomComponent>,
